# Generated by Django 3.2.9 on 2025-03-24 18:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('created_by', models.ForeignKey(limit_choices_to={'user_role': 'admin'}, on_delete=django.db.models.deletion.CASCADE, to='store.user')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(limit_choices_to={'user_role': 'admin'}, on_delete=django.db.models.deletion.CASCADE, to='store.user')),
            ],
        ),
    ]
